...
class Abbonamento{
    ...
    function displayEsercizio(){
    
        $html='<form action="esercizio.php" method="POST">';
        $html.='<label for="abbonamento">Durata abbonamento</label>';
        $html.='<select id="abbonamento" name="abbonamento">';
        $html.='<option value="mensile">mensile</option>';
    ...
    function display4(){
        ...
        $html.='<li>abbonamento:' . $_SESSION['abbonamento'] . '</li>';
    ...
    function saveEsercizio(){
        $_SESSION['abbonamento']=$_POST['abbonamento'];

...
function get_banner($items){
    ...
    //genera casualmente un numero che useremo come posizione dell'array
    ...
    //memorizza il fatto che sarà memorizzato il banner numero $index
    ...
    $html .= '<a href ="gotobannerlink.php?id=' . $index . '">' . $banners['name'] . '</a>';
    
    return $html;

}

function get_var_banner(){
    global $banners;
    return $banners;
